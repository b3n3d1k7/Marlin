...
#define STRING_CONFIG_H_AUTHOR "(b3n3d1k7)" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  // custom - determined by running M303 E-1 S60 C8
  #define DEFAULT_BED_KP 39.6
  #define DEFAULT_BED_KI 3.9
  #define DEFAULT_BED_KD 268.4
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 415 } // titan/BMG extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -2.75 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
